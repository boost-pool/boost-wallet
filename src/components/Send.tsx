...
import { addressSlice, amountIsValid } from '../utils/utils';
...
import successAnimation from '../resources/lottie/success.json';
              ...
              <Tab.Panels className="mt-2">
                <div className="w-full mt-2">
                  <div className="block p-6">
                    {
                      outputs.length > 1 ? <p className="text-right cursor-pointer">
                        <a
