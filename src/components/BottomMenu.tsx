  ...
  return (
    <>
      ...
      <nav
        ...
        <a href="/network" className="w-full block py-2 px-3 text-center hover:bg-blue-200 hover:text-blue-800">
        ...
        <a href="/p2p" className="w-full block py-2 px-3 text-center hover:bg-blue-200 hover:text-blue-800">
        ...
        <a href="/settings" className="w-full block py-2 px-3 text-center hover:bg-blue-200 hover:text-blue-800">
